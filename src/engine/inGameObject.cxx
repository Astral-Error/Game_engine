...
inGameObject::inGameObject(float init_x, float init_y, int init_width,
                           int init_height, float init_speed,
    ...
    : x(init_x), y(init_y), width(init_width), height(init_height),
      ...
      objectTag(init_objectTag) {}
inGameObject::inGameObject()
    : x(0.0), y(0.0), width(0), height(0), movementSpeed(0) {}
...
void inGameObject::renderObject(SDL_Renderer *renderer) {
  ...
  SDL_SetRenderDrawColor(renderer, objectColor.r, objectColor.g, objectColor.b,
                         objectColor.a);
...
void inGameObject::setVelocityY(float newVelocityY) {
